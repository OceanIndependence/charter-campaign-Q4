...
export function demoDetail(yfId) {
  ...
  return {
    ...
    // LOCATION is the summer base port; the operating areas drive the Tier 2 pre-tick.
    cruisingArea: y.basePort,
    operatingAreas: y.cruisingArea,
    currency: y.currency,
