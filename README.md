...
- Like Tier 3, the page has a dark theme (the default) and a light theme, chosen in the
  form's THEME control. On both tiers the light theme keeps the header black and ends
  on a black band (the consultant block and what follows it); Tier 2 also keeps the
  globe stage black.
